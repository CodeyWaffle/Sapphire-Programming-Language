# ----------------------------------------------------------------------
# Sapphire Engine v1.7: Stable Basic Engine (more Pygame shapes and abort() command)
...
def displaySize(w, h):
    """Sets the window size. Can be called at the start of the script."""
    global screen, WIDTH, HEIGHT
    WIDTH, HEIGHT = w, h
    screen = pygame.display.set_mode((WIDTH, HEIGHT))

def clearDisplay(color=(0, 0, 0)):
    """Clears the screen with a specific color (default is black)."""
    if screen:
        screen.fill(color)
